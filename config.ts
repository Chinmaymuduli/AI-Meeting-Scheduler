...
export const SettingsConfiguration = {
    ...
    agent: {
        ...
        think: {
            ...
            prompt: "You are a helpful assistant that can provide meeting information. If the user asks to end the call, use the 'end_call' function to terminate the call politely.",
            functions: [
                {
                    name: "end_call",
